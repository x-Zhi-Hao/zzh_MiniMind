...
from model.ZzhModel import ZzhMindConfig
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ZzhMind Pretraining")
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="ZzhMind-Pretrain", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        # 构建实验名称，包含关键超参数
        wandb_run_name = f"ZzhMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
